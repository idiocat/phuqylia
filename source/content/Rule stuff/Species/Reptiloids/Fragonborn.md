...
| Fragon             | Colour                                                                                                                                               | Quirk                       | Damage Types       |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ------------------ |
| Tourmaline         | Verdant green melting into volcanic pink, with deep umber undertones                                                                                 | **All-Consuming Passion**   | Fire, Poison       |
| Lapis Lazuli       | Deep blue of a midnight sky, speckled with flecks of gleaming gold                                                                                   | **Detached Perfectionism**  | Radiant, Psychic   |
| Lace Agate         | Layered bands of milky white, soft grey, and translucent blue                                                                                        | **Righteous Inflexibility** | Lightning, Thunder |
| Hematite           | Dull and non-reflective black or dark grey                                                                                                           | **Insatiable Hunger**       | Necrotic, Force    |
| Ammolite           | Dazzling ever-shifting iridescence. Red, green, blue, violet morphing into each other with every slight movement or angle of light like oil on water | **Reactive Instability**    | Psychic, Poison    |
| Snowflake Obsidian | Glossy pitch-black base interspersed with distinctive white speckles                                                                                 | **Polarized Duality**       | Necrotic, Radiant  |


**Fragonic Leap**. When you reach lvl 5, you can channel fragonic magic to give yourself temporary flight \[*sic!*]. As a Bonus Action, you cast Jump on yourself. Once you use this trait, you can't use it again until you finish a Long Rest.



\* e.g., with 20 movement speed and 10 strength, you can jump for 20 feet and still have 10 movement speed left