...
**Size**: Medium (about 6.5-8 feet tall)
...
**Relentless Endurance**. When you make a death saving throw, you can choose to critically succeed. You can use this feature once per long rest.

**Adrenalin Rush**. You can take dash as a bonus action and gain {your proficiency} temp. hp. You can use this trait {you proficiency} times per short rest.

**Survival Instinct**. You have advantage on survival checks.

**Nomadic Perseverance**. You can travel up to 20 hours without risking exhaustion. You also have advantage on constitution saving throws against diseases and drunkenness.
...
**Swift**. You climbing speed equals your ms.
